package com.simon.arpe.ezyweather;
...
import com.simon.arpe.ezyweather.model.WeatherModel;
...
public class MainActivity extends ActionBarActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks {
	...
	private void shutOtto() {
		BusProvider.getInstance().unregister(this);

	}

	private void startConnection() {
		weatherModel.checkLondon();
	...
	@Subscribe
	public void weatherReceived(WeatherEvent event) {
		Log.d(TAG, "weatherReceived");
		TextView label = (TextView) findViewById(R.id.section_label);
